...
export function SignIn() {
  ...
  return (
    <div className="w-screen h-screen flex bg-zinc-900">
      <div className="h-full w-2/3 border-r-[1px] border-zinc-800 p-8">
      ...
      <div className="h-full w-2/5 relative flex items-center justify-center p-12">
        ...
        <div className="w-full bg-zinc-800 py-12 px-20 rounded-sm">
          ...
          <form className="mt-6 space-y-4">
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                className="h-10 rounded-md bg-transparent text-zinc-400 text-sm border-2 border-zinc-700 outline-none px-4 focus:border-yellow-500"
              />
            </div>

            <div className="flex flex-col gap-1">
              <label htmlFor="" className="text-zinc-400 text-sm">
                Senha
              </label>
              ...
              <div className="relative">
                <input
                  ...
                  className=" w-full h-10 rounded-md bg-transparent text-zinc-400 text-sm border-2 border-zinc-700 outline-none px-4 focus:border-yellow-500"
                />
